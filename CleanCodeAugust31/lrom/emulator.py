...
class ScatteringLROM:
    ...
    def cross_sections(
        ...
        ``linear_solver`` is a callable accepting stacked matrices and right
        sides.  It permits the same trained model to use NumPy or a GPU-backed
        solver without changing the fitted equation.
        """
