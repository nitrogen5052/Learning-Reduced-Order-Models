...
class Notebook01Config:
    ...
    n_basis: int = 4
    n_u: int = 8
    vv_train_fraction: float = 0.10
    vv_test_fraction: float = 0.35
    rv_train_fraction: float = 0.06
    rv_test_fraction: float = 0.30
    broad_vv_train_fraction: float = 0.22
    broad_rv_train_fraction: float = 0.20
    broad_vv_scan_fraction: float = 0.75
    broad_rv_scan_fraction: float = 0.65
    n_vv_train: int = 35
    n_vv_test: int = 41
    n_box_train: int = 70
    n_box_test: int = 43
