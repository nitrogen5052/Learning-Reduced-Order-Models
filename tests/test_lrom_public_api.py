...
import lrom
import lrom_legacy.v1_0 as lrom_v1_0
...
def test_notebook1_snapshot_imports_as_legacy_namespace() -> None:
    assert lrom_v1_0.__version__ == "1.0.0"
    assert lrom_v1_0.LROM.__name__ == "LROM"
    assert callable(lrom_v1_0.load)
    assert lrom_v1_0 is not lrom
